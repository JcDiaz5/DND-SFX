...
# Email (for verification codes). Required for email change verification.
...
app.config['MAIL_DEFAULT_SENDER'] = os.getenv('MAIL_DEFAULT_SENDER', '') or os.getenv('MAIL_USERNAME', 'noreply@example.com')
